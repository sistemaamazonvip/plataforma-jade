...
const sector = getSectorBySlug("flutuante")!;

export default async function FlutuanteLayout({ children }: { children: ReactNode }) {
  const profile = await requireRole(["admin", "flutuante"]);
