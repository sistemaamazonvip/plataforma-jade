...
const sector = getSectorBySlug("skiptravel")!;

export default async function SkipTravelLayout({ children }: { children: ReactNode }) {
  const profile = await requireRole(["admin", "skiptravel"]);
  return (
