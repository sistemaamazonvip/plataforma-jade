...
const sector = getSectorBySlug("tarifario")!;

export default async function TarifarioLayout({ children }: { children: ReactNode }) {
  const profile = await requireRole(["admin", "tarifario"]);
  return (
