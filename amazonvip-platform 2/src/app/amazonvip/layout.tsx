...
const sector = getSectorBySlug("amazonvip")!;

export default async function AmazonVipLayout({ children }: { children: ReactNode }) {
  const profile = await requireRole(["admin", "amazonvip"]);
  return (
